...
If we now wanted to know the statistical precipitation height based on the constructed tibble, e.g. for an event of 4 hours duration corresponding to a recurrence interval in 1:100 years, it's just a matter of indexing. However, there is also a function helping you out.
