...
A more sophisticated and robust approach would be to use the GEV parameters available for each grid cell in order to reconstruct the underlying extreme value distribution. Check the docs under `?kostra_dwd_2020_params` for more information.
...
Cell-specific statistical values can now additionally be visualized as intensity-duration-frequency curves ...
