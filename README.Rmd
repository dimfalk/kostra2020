...
[![Codecov test coverage](https://codecov.io/gh/dmflk/kostra2010R/branch/main/graph/badge.svg)](https://app.codecov.io/gh/dmflk/kostra2010R?branch=main)
<!-- badges: end -->
...
Finally, we want to determine the return period according to the dataset (without interpolating values at the moment) for a precipitation depth and duration given.
...
See [here](https://github.com/dmflk/kostra2010R/blob/main/.github/CONTRIBUTING.md) if you'd like to contribute.
